...
using PyTrampolineCfgBase_frc__ADXL345_I2C =
...
struct PyTrampolineCfg_frc__ADXL345_I2C :
    PyTrampolineCfgBase_frc__ADXL345_I2C< CfgBase>
{
    using Base = frc::ADXL345_I2C;

    using override_base_GetX_v = frc::ADXL345_I2C;
    using override_base_GetY_v = frc::ADXL345_I2C;
    using override_base_GetZ_v = frc::ADXL345_I2C;
...
struct PyTrampoline_frc__ADXL345_I2C : PyTrampolineBase_frc__ADXL345_I2C<PyTrampolineBase, PyTrampolineCfg> {
    ...
    ADXL345_I2C::AllAxes GetAccelerations() override {
        ...
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(ADXL345_I2C::AllAxes), LookupBase,
            "getAccelerations", );
