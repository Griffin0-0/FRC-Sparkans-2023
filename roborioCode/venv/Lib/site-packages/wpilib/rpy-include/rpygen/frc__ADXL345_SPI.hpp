...
using PyTrampolineCfgBase_frc__ADXL345_SPI =
...
struct PyTrampolineCfg_frc__ADXL345_SPI :
    PyTrampolineCfgBase_frc__ADXL345_SPI< CfgBase>
{
    using Base = frc::ADXL345_SPI;

    using override_base_GetX_v = frc::ADXL345_SPI;
    using override_base_GetY_v = frc::ADXL345_SPI;
    using override_base_GetZ_v = frc::ADXL345_SPI;
...
struct PyTrampoline_frc__ADXL345_SPI : PyTrampolineBase_frc__ADXL345_SPI<PyTrampolineBase, PyTrampolineCfg> {
    ...
    ADXL345_SPI::AllAxes GetAccelerations() override {
        ...
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(ADXL345_SPI::AllAxes), LookupBase,
            "getAccelerations", );
