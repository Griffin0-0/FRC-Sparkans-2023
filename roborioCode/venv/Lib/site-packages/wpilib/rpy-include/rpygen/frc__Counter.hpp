...
#define RPYGEN_DISABLE_SetMaxPeriod_Tsecond_t
...
using PyTrampolineCfgBase_frc__Counter =
...
struct PyTrampolineCfg_frc__Counter :
    PyTrampolineCfgBase_frc__Counter< CfgBase>
{
...
using PyTrampolineBase_frc__Counter =
...
template <typename PyTrampolineBase, typename PyTrampolineCfg>
struct PyTrampoline_frc__Counter : PyTrampolineBase_frc__Counter<PyTrampolineBase, PyTrampolineCfg> {
    using PyTrampolineBase_frc__Counter<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_frc__Counter;
