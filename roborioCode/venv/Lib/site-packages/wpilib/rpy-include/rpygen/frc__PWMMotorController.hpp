...
#include <..\_impl\include\frc\motorcontrol\PWMMotorController.h>
...
using PyTrampolineCfgBase_frc__PWMMotorController =
...
struct PyTrampolineCfg_frc__PWMMotorController :
    PyTrampolineCfgBase_frc__PWMMotorController< CfgBase>
{
...
PyTrampolineBase_frc__PWMMotorController<PyTrampolineBase, PyTrampolineCfg>(std::move(name), std::move(channel))
    {}
#endif
