...
using PyTrampolineCfgBase_frc__Relay =
...
struct PyTrampolineCfg_frc__Relay :
    PyTrampolineCfgBase_frc__Relay< CfgBase>
{
...
using PyTrampolineBase_frc__Relay =
...
template <typename PyTrampolineBase, typename PyTrampolineCfg>
struct PyTrampoline_frc__Relay : PyTrampolineBase_frc__Relay<PyTrampolineBase, PyTrampolineCfg> {
    using PyTrampolineBase_frc__Relay<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_frc__Relay;
