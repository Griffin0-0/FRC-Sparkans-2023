...
#include <..\..\_impl\include\frc\shuffleboard\ShuffleboardWidget.h>
...
"@tparam Derived the self type";
  ...
  cls_ShuffleboardWidget
      .def("withWidget", static_cast<  Derived&(frc::ShuffleboardWidget<Derived>::*)(BuiltInWidgets)>(
...
"          @see BuiltInWidgets")
      ...
      .def("withWidget", static_cast<  Derived&(frc::ShuffleboardWidget<Derived>::*)(const WidgetType&)>(
&frc::ShuffleboardWidget<Derived>::WithWidget),
      py::arg("widgetType"), release_gil(), py::return_value_policy::reference_internal, py::doc(
    "Sets the type of widget used to display the data. If not set, the default\n"
"widget type will be used.\n"
...
":returns: this widget object")
      ...
      .def("withWidget", static_cast<  Derived&(frc::ShuffleboardWidget<Derived>::*)(std::string_view)>(
&frc::ShuffleboardWidget<Derived>::WithWidget),
      py::arg("widgetType"), release_gil(), py::return_value_policy::reference_internal, py::doc(
    "Sets the type of widget used to display the data. If not set, the default\n"
