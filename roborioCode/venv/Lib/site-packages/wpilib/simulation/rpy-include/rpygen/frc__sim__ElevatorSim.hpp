...
#include <..\..\_impl\include\frc\simulation\ElevatorSim.h>
...
using PyTrampolineCfgBase_frc__sim__ElevatorSim =
    PyTrampolineCfg_frc__sim__LinearSystemSim<2, 1, 1, 
CfgBase
>;

template <typename CfgBase = EmptyTrampolineCfg>
struct PyTrampolineCfg_frc__sim__ElevatorSim :
    PyTrampolineCfgBase_frc__sim__ElevatorSim< CfgBase>
{
    using Base = frc::sim::ElevatorSim;

    using override_base_KGetCurrentDraw_v = frc::sim::ElevatorSim;
    using override_base_UpdateX_KRTVectord_2__KRTVectord_1__Tsecond_t = frc::sim::ElevatorSim;
};


template <typename PyTrampolineBase, typename PyTrampolineCfg>
using PyTrampolineBase_frc__sim__ElevatorSim =
...
template <typename PyTrampolineBase, typename PyTrampolineCfg>
struct PyTrampoline_frc__sim__ElevatorSim : PyTrampolineBase_frc__sim__ElevatorSim<PyTrampolineBase, PyTrampolineCfg> {
    using PyTrampolineBase_frc__sim__ElevatorSim<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_frc__sim__ElevatorSim;
