    ...
    CfgBase
{
    ...
    using override_base_UpdateX_KRTVectord_States__KRTVectord_Inputs__Tsecond_t = frc::sim::LinearSystemSim<States, Inputs, Outputs>;
};
...
#ifndef RPYGEN_DISABLE_UpdateX_KRTVectord_States__KRTVectord_Inputs__Tsecond_t
    Vectord<States > UpdateX(const Vectord<States>& currentXhat, const Vectord<Inputs>& u, units::second_t dt) override {
        using LookupBase = typename PyTrampolineCfg::Base;
        using CxxCallBase = typename PyTrampolineCfg::override_base_UpdateX_KRTVectord_States__KRTVectord_Inputs__Tsecond_t;
...
#ifndef RPYBLD_DISABLE_ClampInput_TVectord_Inputs_
...
":param dt: The time between updates.")
      ...
      .def("getOutput", static_cast<const  Vectord<Outputs>&(frc::sim::LinearSystemSim<States, Inputs, Outputs>::*)() const>(
...
":returns: An element of the current output of the plant.")
      ...
      .def("setInput", static_cast<  void(frc::sim::LinearSystemSim<States, Inputs, Outputs>::*)(const Vectord<Inputs>&)>(
...
":param dt:          The time difference between controller updates.")
      ...
      .def("_clampInput", static_cast<  Vectord<Inputs>(frc::sim::LinearSystemSim<States, Inputs, Outputs>::*)(Vectord<Inputs >)>(&LinearSystemSim_Trampoline::ClampInput),
      py::arg("u"), release_gil(), py::doc(
