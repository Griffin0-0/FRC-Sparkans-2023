...
using PyTrampolineCfgBase_frc__DifferentialDriveVoltageConstraint =
    PyTrampolineCfg_frc__TrajectoryConstraint<
CfgBase
>;

template <typename CfgBase = EmptyTrampolineCfg>
struct PyTrampolineCfg_frc__DifferentialDriveVoltageConstraint :
    PyTrampolineCfgBase_frc__DifferentialDriveVoltageConstraint< CfgBase>
{
    using Base = frc::DifferentialDriveVoltageConstraint;

    using override_base_KMaxVelocity_KRTPose2d_Tcurvature_t_Tmeters_per_second_t = frc::DifferentialDriveVoltageConstraint;
    using override_base_KMinMaxAcceleration_KRTPose2d_Tcurvature_t_Tmeters_per_second_t = frc::DifferentialDriveVoltageConstraint;
};


template <typename PyTrampolineBase, typename PyTrampolineCfg>
using PyTrampolineBase_frc__DifferentialDriveVoltageConstraint =
...
template <typename PyTrampolineBase, typename PyTrampolineCfg>
struct PyTrampoline_frc__DifferentialDriveVoltageConstraint : PyTrampolineBase_frc__DifferentialDriveVoltageConstraint<PyTrampolineBase, PyTrampolineCfg> {
    using PyTrampolineBase_frc__DifferentialDriveVoltageConstraint<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_frc__DifferentialDriveVoltageConstraint;
