...
#include <..\..\_impl\include\frc\controller\ImplicitModelFollower.h>
...
"https://file.tavsys.net/control/controls-engineering-in-frc.pdf.";
  ...
  cls_ImplicitModelFollower
      ...
      py::arg("A"), py::arg("B"), py::arg("Aref"), py::arg("Bref"), release_gil()    , py::keep_alive<1, 2>()    , py::keep_alive<1, 3>()    , py::keep_alive<1, 4>()    , py::keep_alive<1, 5>(), py::doc(
...
":param Bref: Continuous input matrix whose dynamics should be followed.")
      ...
      .def("U", static_cast<const  InputVector&(frc::ImplicitModelFollower<States, Inputs>::*)() const>(
...
":returns: The control input.")
      ...
      .def("U", static_cast<  double(frc::ImplicitModelFollower<States, Inputs>::*)(int) const>(
...
":returns: The row of the control input vector.")
      ...
      .def("reset", &frc::ImplicitModelFollower<States, Inputs>::Reset, release_gil(), py::doc(
