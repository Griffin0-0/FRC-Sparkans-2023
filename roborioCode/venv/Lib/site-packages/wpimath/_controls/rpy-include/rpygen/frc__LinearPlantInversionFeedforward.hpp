...
":param dt: Discretization timestep.")
      ...
      .def("uff", static_cast<const  InputVector&(frc::LinearPlantInversionFeedforward<States, Inputs>::*)() const>(
...
":returns: The row of the calculated feedforward.")
      ...
      .def("R", static_cast<const  StateVector&(frc::LinearPlantInversionFeedforward<States, Inputs>::*)() const>(
...
":returns: The row of the current reference vector.")
      ...
      .def("reset", static_cast<  void(frc::LinearPlantInversionFeedforward<States, Inputs>::*)(const Vectord<States >&)>(
...
&frc::LinearPlantInversionFeedforward<States, Inputs>::Reset), release_gil(), py::doc(
    "Resets the feedforward with a zero initial state vector.")
      ...
      .def("calculate", static_cast<  InputVector(frc::LinearPlantInversionFeedforward<States, Inputs>::*)(const Vectord<States >&)>(
...
":returns: The calculated feedforward.")
      ...
      .def("calculate", static_cast<  InputVector(frc::LinearPlantInversionFeedforward<States, Inputs>::*)(const Vectord<States >&, const Vectord<States >&)>(
&frc::LinearPlantInversionFeedforward<States, Inputs>::Calculate),
