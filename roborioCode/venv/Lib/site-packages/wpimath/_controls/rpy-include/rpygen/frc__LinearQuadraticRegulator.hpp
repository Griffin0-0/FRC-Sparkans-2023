...
"@tparam Inputs Number of inputs.";
  ...
  cls_LinearQuadraticRegulator
      .def(py::init<const Matrixd<States, States>&, const Matrixd<States, Inputs>&, const wpi::array<double, States >&, const wpi::array<double, Inputs >&, units::second_t>(),
...
"           @throws std::invalid_argument If the system is uncontrollable.")
      ...
      .def("K", static_cast<const  Matrixd<Inputs , States>&(frc::LinearQuadraticRegulator<States, Inputs>::*)() const>(
&frc::LinearQuadraticRegulator<States, Inputs>::K), release_gil(), py::doc(
    "Returns the controller matrix K.")
  )
    
      .def("K", static_cast<  double(frc::LinearQuadraticRegulator<States, Inputs>::*)(int, int) const>(
...
":param j: Column of K.")
      ...
      .def("R", static_cast<const  StateVector&(frc::LinearQuadraticRegulator<States, Inputs>::*)() const>(
...
":returns: The reference vector.")
      ...
      .def("R", static_cast<  double(frc::LinearQuadraticRegulator<States, Inputs>::*)(int) const>(
...
":returns: The row of the reference vector.")
      ...
      .def("U", static_cast<const  InputVector&(frc::LinearQuadraticRegulator<States, Inputs>::*)() const>(
...
":returns: The control input.")
      ...
      .def("U", static_cast<  double(frc::LinearQuadraticRegulator<States, Inputs>::*)(int) const>(
...
":returns: The row of the control input vector.")
      ...
      .def("reset", &frc::LinearQuadraticRegulator<States, Inputs>::Reset, release_gil(), py::doc(
    "Resets the controller.")
  )
    
      .def("calculate", static_cast<  InputVector(frc::LinearQuadraticRegulator<States, Inputs>::*)(const Vectord<States >&)>(
...
":param x: The current state x.")
      ...
      .def("calculate", static_cast<  InputVector(frc::LinearQuadraticRegulator<States, Inputs>::*)(const Vectord<States >&, const Vectord<States >&)>(
&frc::LinearQuadraticRegulator<States, Inputs>::Calculate),
