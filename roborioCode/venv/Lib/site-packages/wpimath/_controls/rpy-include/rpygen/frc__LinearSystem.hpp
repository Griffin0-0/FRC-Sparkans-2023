...
"          @throws std::domain_error if any matrix element isn't finite.")
      ...
      .def("A", static_cast<const  Matrixd<States , States>&(frc::LinearSystem<States, Inputs, Outputs>::*)() const>(
...
":param j: Column of A.")
      ...
      .def("B", static_cast<const  Matrixd<States , Inputs>&(frc::LinearSystem<States, Inputs, Outputs>::*)() const>(
...
":param j: Column of B.")
      ...
      .def("C", static_cast<const  Matrixd<Outputs , States>&(frc::LinearSystem<States, Inputs, Outputs>::*)() const>(
...
":param j: Column of C.")
      ...
      .def("D", static_cast<const  Matrixd<Outputs , Inputs>&(frc::LinearSystem<States, Inputs, Outputs>::*)() const>(
