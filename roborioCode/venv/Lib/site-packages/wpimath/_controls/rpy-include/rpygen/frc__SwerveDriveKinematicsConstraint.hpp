...
using PyTrampolineCfgBase_frc__SwerveDriveKinematicsConstraint =
...
struct PyTrampolineCfg_frc__SwerveDriveKinematicsConstraint :
    PyTrampolineCfgBase_frc__SwerveDriveKinematicsConstraint< CfgBase>
{
...
struct PyTrampoline_frc__SwerveDriveKinematicsConstraint : PyTrampolineBase_frc__SwerveDriveKinematicsConstraint<PyTrampolineBase, PyTrampolineCfg> {
    using PyTrampolineBase_frc__SwerveDriveKinematicsConstraint<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_frc__SwerveDriveKinematicsConstraint;
