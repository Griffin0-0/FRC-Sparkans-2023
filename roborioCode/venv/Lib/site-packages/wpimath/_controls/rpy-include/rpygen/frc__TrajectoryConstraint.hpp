...
struct PyTrampoline_frc__TrajectoryConstraint : PyTrampolineBase, virtual py::trampoline_self_life_support {
    ...
    TrajectoryConstraint::MinMax MinMaxAcceleration(const Pose2d& pose, units::curvature_t curvature, units::meters_per_second_t speed) const override {
        using LookupBase = typename PyTrampolineCfg::Base;
        RPYBUILD_OVERRIDE_PURE_NAME(TrajectoryConstraint, PYBIND11_TYPE(TrajectoryConstraint::MinMax), LookupBase,
